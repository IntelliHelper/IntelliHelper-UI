    ...
    <div className="space-y-4">
      ...
      <ol className="space-y-3">
        {commands.map((item, index) => (
          <li
            key={item.command}
            className="rounded-xl border border-[var(--glass-chrome-border)] backdrop-blur-[var(--glass-blur)] bg-[color-mix(in_oklch,var(--glass-surface-fill)_36%, var(--glass-mix-into))] p-4"
          >
