...
const richTextSurfaceVariants = cva(
  [
    ...
    "[&_code]:rounded-md [&_code]:border [&_code]:border-[var(--glass-chrome-border)] [&_code]:backdrop-blur-[var(--glass-blur)] bg-[color-mix(in_oklch,var(--glass-surface-fill)_50%,transparent)] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[0.8125rem]",
    "[&_pre]:my-6 [&_pre]:overflow-x-auto [&_pre]:rounded-2xl [&_pre]:border [&_pre]:border-[var(--glass-chrome-border)] [&_pre]:backdrop-blur-[var(--glass-blur)] bg-[color-mix(in_oklch,var(--glass-surface-fill)_50%,transparent)] [&_pre]:p-4 [&_pre]:font-mono [&_pre]:text-[0.8125rem] [&_pre]:leading-[1.75]",
    ...
    "[&_th]:border-b [&_th]:border-[var(--glass-chrome-border)] [&_th]:backdrop-blur-[var(--glass-blur)] bg-[color-mix(in_oklch,var(--glass-surface-fill)_50%,transparent)] [&_th]:px-4 [&_th]:py-3 [&_th]:text-left [&_th]:font-semibold",
